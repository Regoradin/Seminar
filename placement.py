...
def SortStudents(students, seminars, unranked_students):
    ...
    for seminar in seminars:
        seminar_slots += seminar.capacity
    if (seminar_slots/2) < total_students:
        #there is a slight chance that this will fire even if there are enough spots because double period seminars should count double.
        print("\x1b[1;31;40mThere are more students than their are available seminars!\x1b[0m")
